        ...
        <form id="homeSettingsForm" enctype="multipart/form-data">
            ...
            <div class="hs-card mb-4">
                ...
                <div class="row align-items-start g-4">
                    {{-- Left: Mode selector + Upload trigger --}}
                    <div class="col-md-3">
                        {{-- Mode Selector --}}
                        ...
                        <div id="videoUrlSection" style="{{ $homeSettings->mode != 'video' ? 'display:none' : '' }}">
                            {{-- Source Toggle --}}
            ...
            <div class="hs-card mb-4">
                ...
                <div id="buttonsContainer">
                    {{-- Saved Buttons --}}
                    @if($homeSettings->buttons)
                        @foreach($homeSettings->buttons as $index => $btn)
            ...
            <div class="d-none">
                <input type="checkbox" name="show_cv_button" id="showCvButtonInput" {{ $homeSettings->show_cv_button ? 'checked' : '' }}>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('homeSettingsForm').addEventListener('submit', function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.page.home.save') }}",
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
