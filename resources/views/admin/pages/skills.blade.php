                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted mx-auto" style="max-width: 500px;">
                            We are currently building a powerful landing page builder that will allow you to drag-and-drop
                            sections, customize layouts, and manage your site's content effortlessly.
                        </p>
                        <div class="mt-4">
