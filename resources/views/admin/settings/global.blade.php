...
@section('content')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 text-center border-end">
                                <div class="px-2">
                                    ...
                                    <div class="btn-group btn-group-sm w-100 mb-3" role="group">
                                        <input type="radio" class="btn-check" name="logo_type" id="logoTypeText" value="text" {{ ($siteSettings->logo_type ?? 'text') == 'text' ? 'checked' : '' }}>
                                        <label class="btn btn-outline-accent" for="logoTypeText"><i class="ti ti-typography"></i> Text Logo</label>
                                        
                                        <input type="radio" class="btn-check" name="logo_type" id="logoTypeImage" value="image" {{ ($siteSettings->logo_type ?? 'text') == 'text' ? '' : 'checked' }}>
                                        <label class="btn btn-outline-accent" for="logoTypeImage"><i class="ti ti-photo"></i> Image Logo</label>
                                    </div>

                                    <!-- Logo Text Input -->
                                    <div id="logoTextInputBox" class="mb-3" style="{{ ($siteSettings->logo_type ?? 'text') == 'image' ? 'display:none' : '' }}">
                                        <div class="input-group-custom shadow-sm">
                                            <span class="input-group-text p-1 px-2" style="min-width: 80px;">Text</span>
                                            <input type="text" class="form-control p-1 px-2" name="logo_text" value="{{ $siteSettings->logo_text ?? '' }}" placeholder="Navbar Logo Text">
                                        </div>
                                    </div>

                                    <!-- Logo Image Upload -->
                                    <div id="logoUploadBox" class="logo-upload-box shadow-sm mb-3" style="{{ ($siteSettings->logo_type ?? 'text') == 'text' ? 'display:none' : '' }}">
                                        @if(isset($siteSettings) && $siteSettings->logo_image)
                                        ...
                                        <div class="preview-area" id="logoPreview">
                                            @if(isset($siteSettings) && $siteSettings->logo_image)
                                                <img src="{{ asset('storage/' . $siteSettings->logo_image) }}" alt="Logo">
                                            @else
                            ...
                            <div class="col-md-4">
                                <div class="input-group-custom mb-2">
                                    ...
                                    <input type="text" class="form-control" name="site_title" value="{{ $siteSettings->site_title ?? '' }}">
                                </div>
                                <div class="input-group-custom mb-2">
                                    <span class="input-group-text">Time Zone</span>
                                    <select class="form-select" name="time_zone">
                                        <option value="UTC +06:00" {{ ($siteSettings->time_zone ?? '') == 'UTC +06:00' ? 'selected' : '' }}>UTC +06:00</option>
                                        <option value="UTC +00:00" {{ ($siteSettings->time_zone ?? '') == 'UTC +00:00' ? 'selected' : '' }}>UTC +00:00</option>
                                    </select>
                                </div>
                                <div class="input-group-custom mb-2">
                                    <span class="input-group-text">Contact Mail</span>
                                    <input type="email" class="form-control" name="contact_mail" value="{{ $siteSettings->contact_mail ?? '' }}">
                                </div>
                                <div class="input-group-custom">
                                    <span class="input-group-text">Address</span>
                                    <input type="text" class="form-control" name="address" value="{{ $siteSettings->address ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="input-group-custom mb-2">
                                    <span class="input-group-text">Default Font</span>
                                    <input type="text" class="form-control" name="default_font" value="{{ $siteSettings->default_font ?? '' }}">
                                </div>
                                <div class="input-group-custom mb-2">
                                    <span class="input-group-text">Heading Font</span>
                                    <input type="text" class="form-control" name="heading_font" value="{{ $siteSettings->heading_font ?? '' }}">
                                </div>
                                <div class="input-group-custom mb-2">
                                    <span class="input-group-text">Contact No</span>
                                    <input type="text" class="form-control" name="contact_no" value="{{ $siteSettings->contact_no ?? '' }}">
                                </div>
                                <div class="input-group-custom">
                                    <span class="input-group-text">Map Link</span>
                                    <input type="text" class="form-control" name="map_link" value="{{ $siteSettings->map_link ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <div class="color-picker-item">
                                        ...
                                        <input type="text" class="color-code" name="body_bg" value="{{ $siteSettings->body_bg ?? '#FFFFFF' }}">
                                        <input type="color" value="{{ $siteSettings->body_bg ?? '#FFFFFF' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Primary</span>
                                        <input type="text" class="color-code" name="primary_color" value="{{ $siteSettings->primary_color ?? '#EA4335' }}">
                                        <input type="color" value="{{ $siteSettings->primary_color ?? '#EA4335' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Heading</span>
                                        <input type="text" class="color-code" name="heading_color" value="{{ $siteSettings->heading_color ?? '#1A1A1A' }}">
                                        <input type="color" value="{{ $siteSettings->heading_color ?? '#1A1A1A' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Accent</span>
                                        <input type="text" class="color-code" name="accent_color" value="{{ $siteSettings->accent_color ?? '#4285F4' }}">
                                        <input type="color" value="{{ $siteSettings->accent_color ?? '#4285F4' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Surface</span>
                                        <input type="text" class="color-code" name="surface_color" value="{{ $siteSettings->surface_color ?? '#F8F9FA' }}">
                                        <input type="color" value="{{ $siteSettings->surface_color ?? '#F8F9FA' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Contrast</span>
                                        <input type="text" class="color-code" name="contrast_color" value="{{ $siteSettings->contrast_color ?? '#E0E0E0' }}">
                                        <input type="color" value="{{ $siteSettings->contrast_color ?? '#E0E0E0' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <div class="color-picker-item">
                                        <span class="label">Primary</span>
                                        <input type="text" class="color-code" name="nav_primary" value="{{ $siteSettings->nav_primary ?? '#EA4335' }}">
                                        <input type="color" value="{{ $siteSettings->nav_primary ?? '#EA4335' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Hover</span>
                                        <input type="text" class="color-code" name="nav_hover" value="{{ $siteSettings->nav_hover ?? '#D33426' }}">
                                        <input type="color" value="{{ $siteSettings->nav_hover ?? '#D33426' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Mobile BG</span>
                                        <input type="text" class="color-code" name="nav_mobile_bg" value="{{ $siteSettings->nav_mobile_bg ?? '#FFFFFF' }}">
                                        <input type="color" value="{{ $siteSettings->nav_mobile_bg ?? '#FFFFFF' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">DD BG</span>
                                        <input type="text" class="color-code" name="nav_dd_bg" value="{{ $siteSettings->nav_dd_bg ?? '#FFFFFF' }}">
                                        <input type="color" value="{{ $siteSettings->nav_dd_bg ?? '#FFFFFF' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">DD Link</span>
                                        <input type="text" class="color-code" name="nav_dd_link" value="{{ $siteSettings->nav_dd_link ?? '#333333' }}">
                                        <input type="color" value="{{ $siteSettings->nav_dd_link ?? '#333333' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">DD Hover</span>
                                        <input type="text" class="color-code" name="nav_dd_hover" value="{{ $siteSettings->nav_dd_hover ?? '#EA4335' }}">
                                        <input type="color" value="{{ $siteSettings->nav_dd_hover ?? '#EA4335' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mt-4">
                                <div class="form-check form-switch custom-switch d-flex align-items-center gap-2">
                                    <input class="form-check-input" type="checkbox" id="darkModeToggle" name="is_dark_mode" value="1" {{ ($siteSettings->is_dark_mode ?? true) ? 'checked' : '' }}>
                            ...
                            <div id="darkModeColors" class="col-12 mt-4 mb-2">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <div class="color-picker-item">
                                        <span class="label">Body BG</span>
                                        <input type="text" class="color-code" name="dark_body_bg" value="{{ $siteSettings->dark_body_bg ?? '#121212' }}">
                                        <input type="color" value="{{ $siteSettings->dark_body_bg ?? '#121212' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Primary</span>
                                        <input type="text" class="color-code" name="dark_primary_color" value="{{ $siteSettings->dark_primary_color ?? '#EA4335' }}">
                                        <input type="color" value="{{ $siteSettings->dark_primary_color ?? '#EA4335' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Heading</span>
                                        <input type="text" class="color-code" name="dark_heading_color" value="{{ $siteSettings->dark_heading_color ?? '#FFFFFF' }}">
                                        <input type="color" value="{{ $siteSettings->dark_heading_color ?? '#FFFFFF' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Accent</span>
                                        <input type="text" class="color-code" name="dark_accent_color" value="{{ $siteSettings->dark_accent_color ?? '#4285F4' }}">
                                        <input type="color" value="{{ $siteSettings->dark_accent_color ?? '#4285F4' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Surface</span>
                                        <input type="text" class="color-code" name="dark_surface_color" value="{{ $siteSettings->dark_surface_color ?? '#1E1E1E' }}">
                                        <input type="color" value="{{ $siteSettings->dark_surface_color ?? '#1E1E1E' }}">
                                    </div>
                                    <div class="color-picker-item">
                                        <span class="label">Contrast</span>
                                        <input type="text" class="color-code" name="dark_contrast_color" value="{{ $siteSettings->dark_contrast_color ?? '#333333' }}">
                                        <input type="color" value="{{ $siteSettings->dark_contrast_color ?? '#333333' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 p-3">
                    <form id="seoSettingsForm">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="meta_description" rows="5" placeholder="Enter meta description...">{{ $siteSettings->meta_description ?? '' }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold small">Meta Keywords</label>
                            <input type="text" class="form-control" name="meta_keywords" placeholder="keyword1, keyword2, ..." value="{{ $siteSettings->meta_keywords ?? '' }}">
                        </div>
                        <div class="row align-items-end">
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold small">Google Analytics ID</label>
                                <input type="text" class="form-control" name="google_analytics_id" placeholder="UA-XXXXXXXXX-X" value="{{ $siteSettings->google_analytics_id ?? '' }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <div
                                    class="form-check form-switch custom-switch d-flex align-items-center gap-2 justify-content-end">
                                    <input class="form-check-input" type="checkbox" id="indexToggle" name="allow_indexing" value="1" {{ ($siteSettings->allow_indexing ?? true) ? 'checked' : '' }}>
                    ...
                    <form id="emailSettingsForm">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="smtp_host" placeholder="smtp.mailtrap.io" value="{{ $siteSettings->smtp_host ?? '' }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold small">SMTP Port</label>
                                <input type="text" class="form-control" name="smtp_port" placeholder="2525" value="{{ $siteSettings->smtp_port ?? '' }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold small">Encryption Type</label>
                                <select class="form-select" name="encryption_type">
                                    <option value="tls" {{ ($siteSettings->encryption_type ?? '') == 'tls' ? 'selected' : '' }}>TLS</option>
                                    <option value="ssl" {{ ($siteSettings->encryption_type ?? '') == 'ssl' ? 'selected' : '' }}>SSL</option>
                                    <option value="none" {{ ($siteSettings->encryption_type ?? '') == 'none' ? 'selected' : '' }}>None</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold small">SMTP User Name</label>
                                <input type="text" class="form-control" name="smtp_username" placeholder="your_username" value="{{ $siteSettings->smtp_username ?? '' }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold small">Password</label>
                                <input type="password" class="form-control" name="smtp_password" placeholder="********" value="{{ $siteSettings->smtp_password ?? '' }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold small">Sender Name</label>
                                <input type="text" class="form-control" name="sender_name" placeholder="Lavender Portfolio" value="{{ $siteSettings->sender_name ?? '' }}">
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            handleAjaxForm('generalSettingsForm', '{{ route('settings.saveGeneral') }}');
            handleAjaxForm('seoSettingsForm', '{{ route('settings.saveSeo') }}');
            handleAjaxForm('emailSettingsForm', '{{ route('settings.saveEmail') }}');
