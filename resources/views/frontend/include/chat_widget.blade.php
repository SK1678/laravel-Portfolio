@auth
        ...
        @else
            ...
            <div class="chat-header p-3 text-white d-flex justify-content-between align-items-center flex-shrink-0">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <span class="fw-bold">Chat with {{ $siteOwner->name ?? 'Meher Kanti Sarkar' }}</span>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const isAdmin = {{ auth()->user()->is_site_owner ? 'true' : 'false' }};
            ...
            if (!isAdmin) {
                        ...
                        .then(messages => {
                            ...
                            messages.forEach(msg => {
                                ...
                                if (!existingMsg) {
                                    ...
                                    const isOut = msg.sender_id == '{{ auth()->id() }}';
                ...
                function postPublicChat(formData) {
                    fetch('{{ route('chat.store') }}', { method: 'POST', body: formData })
                        .then(res => res.json())
                        .then(msg => {
