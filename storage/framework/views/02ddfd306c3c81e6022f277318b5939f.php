            ...
            <div class="text-center">
                <div class="mb-4">
                    <a href="index.html" class="d-inline-block mb-4">
                        <img src="<?php echo e(asset('/dashboard_assets/images/logo-icon.svg')); ?>" alt="" width="36">
                        <span class="ms-2"><img src="<?php echo e(asset('/dashboard_assets/images/logo.svg')); ?>" alt=""></span>
                    </a>
                </div>
                ...
                <h1 class="display-1 fw-bold text-primary mb-2"><?php echo e($status); ?></h1>
                <h2 class="card-title h4 mb-3"><?php echo e($title); ?></h2>
                <p class="text-muted mb-4"><?php echo e($message); ?></p>

                <a href="<?php echo e(url()->previous() == url()->current() ? route('home') : url()->previous()); ?>" class="btn btn-outline-secondary me-2">Go Back</a>
...
</html><?php /**PATH E:\LocalServer\htdocs\myPortfolio\resources\views/admin/error.blade.php ENDPATH**/ ?>