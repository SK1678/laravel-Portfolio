        ...
        <div class="card  h-100">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item d-flex align-items-center gap-3">
              <img src="<?php echo e(asset('/dashboard_assets/images/product-2.png')); ?>" class="rounded" width="48">
            ...
            <!-- repeat -->
            <li class="list-group-item d-flex align-items-center gap-3">
              <img src="<?php echo e(asset('/dashboard_assets/images/product-1.png')); ?>" class="rounded" width="48">
              <div class="flex-grow-1">
            ...
            <li class="list-group-item d-flex align-items-center gap-3">
              <img src="<?php echo e(asset('/dashboard_assets/images/product-3.png')); ?>" class="rounded" width="48">
              <div class="flex-grow-1">
            ...
            <li class="list-group-item d-flex align-items-center gap-3">
              <img src="<?php echo e(asset('/dashboard_assets/images/product-4.png')); ?>" class="rounded" width="48">
              <div class="flex-grow-1">
            ...
            <li class="list-group-item d-flex align-items-center gap-3">
              <img src="<?php echo e(asset('/dashboard_assets/images/product-5.png')); ?>" class="rounded" width="48">
              <div class="flex-grow-1">
      ...
      <div class="col-lg-4">
        <div class="card  h-100">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item d-flex align-items-center gap-3">
              <img src="<?php echo e(asset('/dashboard_assets/images/product-8.png')); ?>" class="rounded" width="48">
              <div class="flex-grow-1">
            ...
            <li class="list-group-item d-flex align-items-center gap-3">
              <img src="<?php echo e(asset('/dashboard_assets/images/product-10.png')); ?>" class="rounded" width="48">
              <div class="flex-grow-1">
            ...
            <li class="list-group-item d-flex align-items-center gap-3">
              <img src="<?php echo e(asset('/dashboard_assets/images/product-6.png')); ?>" class="rounded" width="48">
              <div class="flex-grow-1">
      ...
      <div class="col-lg-4">
        <div class="card  h-100">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item d-flex align-items-center gap-3">
              <img src="<?php echo e(asset('/dashboard_assets/images/product-7.png')); ?>" class="rounded" width="48">
              <div class="flex-grow-1">
            ...
            <li class="list-group-item d-flex align-items-center gap-3">
              <img src="<?php echo e(asset('/dashboard_assets/images/product-9.png')); ?>" class="rounded" width="48">
              <div class="flex-grow-1">
