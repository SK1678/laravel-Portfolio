<?php $__env->startSection('title', 'Skills Settings'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <form id="skillsSettingsForm">
            ...
            <div class="hs-card mb-4">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="title" class="form-control" value="<?php echo e($settings->title); ?>" placeholder="e.g. Skills">
                    </div>
                    <div class="col-md-12">
            ...
            <div class="hs-card mb-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <p class="hs-section-label mb-0">Professional Skills</p>
                                ...
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" name="names[]" class="form-control" value="<?php echo e($skill->name); ?>" placeholder="e.g. Laravel">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label small fw-bold">Percent (%)</label>
                                            <input type="number" name="percents[]" class="form-control" value="<?php echo e($skill->percent); ?>" min="0" max="100">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        function addSkill(name = '', percent = 90) {
        ...
        document.getElementById('skillsSettingsForm').addEventListener('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.skills.save')); ?>",
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\LocalServer\htdocs\myPortfolio\resources\views/admin/pages/skills_settings.blade.php ENDPATH**/ ?>