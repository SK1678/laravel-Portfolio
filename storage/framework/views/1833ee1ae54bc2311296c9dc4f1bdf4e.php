            ...
            <div class="hs-card mb-4">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="title" class="form-control" value="<?php echo e($settings->title); ?>" placeholder="e.g. Facts">
                    </div>
                    <div class="col-md-12">
                                ...
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" name="names[]" class="form-control" value="<?php echo e($counter->name); ?>" placeholder="e.g. Clients">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label small fw-bold">Value</label>
                                            <input type="text" name="values[]" class="form-control" value="<?php echo e($counter->value); ?>" placeholder="e.g. 232">
                                        </div>
                                    </div>
                                </div>
                            </div>
