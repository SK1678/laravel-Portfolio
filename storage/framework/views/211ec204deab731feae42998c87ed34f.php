<?php $__env->startSection('title', 'Awards & Certifications Settings'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <form id="awardSettingsForm">
            ...
            <div class="hs-card mb-4">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="title" class="form-control" value="<?php echo e($settings->title); ?>" placeholder="e.g. Awards & Certifications">
                    </div>
                    <div class="col-md-12">
                        <label class="form-label small fw-bold">Section Sub Title</label>
                        <textarea name="subtitle" class="form-control" rows="3" placeholder="Enter section description..."><?php echo e($settings->subtitle); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div id="awardsContainer">
                <?php $__currentLoopData = $awards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $award): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="hs-card mb-4 award-item position-relative" data-index="<?php echo e($index); ?>">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-2">
                                ...
                                <input type="text" name="years[]" class="form-control" value="<?php echo e($award->year); ?>" placeholder="e.g. 10 Sep 2025">
                            </div>
                            <div class="col-md-5">
                                <label class="form-label small fw-bold">Award / Certificate Title</label>
                                <input type="text" name="titles[]" class="form-control" value="<?php echo e($award->title); ?>" placeholder="Certificate Name">
                            </div>
                            <div class="col-md-5">
                                <label class="form-label small fw-bold">Issuing Organization</label>
                                <input type="text" name="organizations[]" class="form-control" value="<?php echo e($award->organization); ?>" placeholder="e.g. HackerRank">
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label small fw-bold">Description (Optional)</label>
                            <textarea name="descriptions[]" class="form-control" rows="2" placeholder="Brief details about this achievement..."><?php echo e($award->description); ?></textarea>
                        </div>
                        ...
                        <div class="p-3 bg-light rounded proofs-section">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <button type="button" class="btn btn-xs btn-primary py-0 px-2" onclick="addProof(<?php echo e($index); ?>)">
                            ...
                            <div class="proofs-container">
                                <?php if($award->proofs): ?>
                                    <?php $__currentLoopData = $award->proofs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pIndex => $proof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="proof-item mb-2">
                                            <div class="input-group input-group-sm">
                                                <input type="text" name="proofs[<?php echo e($index); ?>][<?php echo e($pIndex); ?>][label]" class="form-control" value="<?php echo e($proof['label'] ?? 'Certificate'); ?>" style="max-width: 120px;">
                                                <input type="text" name="proofs[<?php echo e($index); ?>][<?php echo e($pIndex); ?>][value]" class="form-control proof-value-input" value="<?php echo e($proof['value'] ?? ''); ?>" placeholder="Link or File URL">
                                                
                                                <button type="button" class="btn btn-outline-secondary btn-upload-proof" title="Upload"><i class="ti ti-upload"></i></button>
                                                <button type="button" class="btn btn-outline-secondary" title="Media Library" onclick="alert('Media Library is coming soon!')"><i class="ti ti-photo"></i></button>
                                                
                                                <div class="input-group-text bg-white">
                                                    <div class="form-check form-switch mb-0">
                                                        <input class="form-check-input proof-lock-toggle" type="checkbox" name="proofs[<?php echo e($index); ?>][<?php echo e($pIndex); ?>][is_protected]" value="1" <?php echo e(isset($proof['is_protected']) && $proof['is_protected'] ? 'checked' : ''); ?>>
                                                        <i class="ti ti-lock ms-1 <?php echo e(isset($proof['is_protected']) && $proof['is_protected'] ? 'text-danger' : 'text-muted'); ?>"></i>
                                                    </div>
                                                </div>
                                                
                                                <input type="text" name="proofs[<?php echo e($index); ?>][<?php echo e($pIndex); ?>][password]" class="form-control proof-password-input <?php echo e(isset($proof['is_protected']) && $proof['is_protected'] ? '' : 'd-none'); ?>" value="<?php echo e($proof['password'] ?? ''); ?>" placeholder="Password" style="max-width: 100px;">
            ...
            <div class="mb-5">
                <button type="button" class="btn btn-outline-primary w-100" onclick="addAward()" style="border-style: dashed;">
    ...
    <script>
        let awardCounter = <?php echo e(count($awards)); ?>;
        ...
        document.getElementById('awardSettingsForm').addEventListener('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.awards.save')); ?>",
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\LocalServer\htdocs\myPortfolio\resources\views/admin/pages/award_settings.blade.php ENDPATH**/ ?>