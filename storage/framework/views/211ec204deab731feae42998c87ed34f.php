                    ...
                    <div class="hs-card mb-4 award-item position-relative" data-index="<?php echo e($index); ?>">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-2">
                                ...
                                <input type="text" name="years[]" class="form-control" value="<?php echo e($award->year); ?>"
                                    placeholder="e.g. 10 Sep 2025">
                            </div>
                            <div class="col-md-5">
                                <label class="form-label small fw-bold">Award / Certificate Title</label>
                                <input type="text" name="titles[]" class="form-control" value="<?php echo e($award->title); ?>"
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" name="organizations[]" class="form-control"
                                    value="<?php echo e($award->organization); ?>" placeholder="e.g. HackerRank">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="descriptions[]" class="form-control" rows="2"
                                placeholder="Brief details about this achievement..."><?php echo e($award->description); ?></textarea>
                        </div>
                                    ...
                                    <?php $__currentLoopData = $award->proofs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pIndex => $proof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="proof-item mb-2">
                                            <div class="input-group input-group-sm">
                                                <input type="text" name="proofs[<?php echo e($index); ?>][<?php echo e($pIndex); ?>][label]"
                                                    class="form-control" value="<?php echo e($proof['label'] ?? 'Certificate'); ?>"
                                                    style="max-width: 120px;">
                                                <input type="text" name="proofs[<?php echo e($index); ?>][<?php echo e($pIndex); ?>][value]"
                                                    class="form-control proof-value-input" value="<?php echo e($proof['value'] ?? ''); ?>"
                                                ...
                                                <div class="input-group-text bg-white">
                                                    <div class="form-check form-switch mb-0">
                                                        <input class="form-check-input proof-lock-toggle" type="checkbox"
                                                            name="proofs[<?php echo e($index); ?>][<?php echo e($pIndex); ?>][is_protected]" value="1" <?php echo e(isset($proof['is_protected']) && $proof['is_protected'] ? 'checked' : ''); ?>>
                                                        <i
                                                            class="ti ti-lock ms-1 <?php echo e(isset($proof['is_protected']) && $proof['is_protected'] ? 'text-danger' : 'text-muted'); ?>"></i>
                                                    </div>
                                                </div>

                                                <input type="text" name="proofs[<?php echo e($index); ?>][<?php echo e($pIndex); ?>][password]"
                                                    class="form-control proof-password-input <?php echo e(isset($proof['is_protected']) && $proof['is_protected'] ? '' : 'd-none'); ?>"
                                                    value="<?php echo e($proof['password'] ?? ''); ?>" placeholder="Password"
