<?php $__env->startSection('title', 'Page Configurations'); ?>
        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="section-card shadow-sm border-0">
                    <a href="<?php echo e(route('admin.page.home')); ?>"
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="section-card shadow-sm border-0">
                    <a href="<?php echo e(route('admin.page.about')); ?>"
                        class="text-center w-100 h-100 d-flex flex-column align-items-center justify-content-center p-4">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="section-card shadow-sm border-0">
                    <a href="<?php echo e(route('admin.counters')); ?>"
                        class="text-center w-100 h-100 d-flex flex-column align-items-center justify-content-center p-4">
                        <div class="section-icon-container bg-light-warning text-warning mb-3">
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\LocalServer\htdocs\myPortfolio\resources\views/admin/pages/index.blade.php ENDPATH**/ ?>