...
<?php $component->withAttributes([]); ?>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="needs-validation" enctype="multipart/form-data" novalidate>
        <?php echo csrf_field(); ?>
        ...
        <div class="row gx-3 mb-3 align-items-stretch">
            ...
            <div class="col-7 d-flex flex-column justify-content-between gap-2">
                <div class="position-relative">
                    <input id="name" name="name" type="text" class="form-control custom-input w-100" placeholder="Full Name" value="<?php echo e(old('name')); ?>" required autofocus>
...
<?php endif; ?>
                ...
                <div class="position-relative">
                    <input id="email" name="email" type="email" class="form-control custom-input w-100" placeholder="Email" value="<?php echo e(old('email')); ?>" required>
                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
            ...
            <div class="col-5">
                ...
                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('profile_image'),'class' => 'mt-1 text-danger small']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('profile_image')),'class' => 'mt-1 text-danger small']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
        ...
        <div class="row gx-3 mb-3 mt-4">
            ...
            <div class="col-6">
                <a href="<?php echo e(route('auth.google')); ?>" class="btn btn-gray w-100 text-decoration-none text-center d-flex align-items-center justify-content-center h-100 gap-2">
        ...
        <div class="text-center pt-2">
            <p class="text-dark mb-0">Already have an account? <a href="<?php echo e(route('login')); ?>" class="text-orange text-decoration-none">Login</a></p>
        </div>
    </form>
...
<?php endif; ?><?php /**PATH E:\LocalServer\htdocs\myPortfolio\resources\views/admin/signup.blade.php ENDPATH**/ ?>