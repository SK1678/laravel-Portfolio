            ...
            <div class="card-body p-5">
                ...
                <div class="text-center mt-4">
                    ...
                    <p class="small text-muted mb-0">
                        <a href="<?php echo e(route('home')); ?>" class="text-primary fw-medium text-decoration-none">Home</a>
                        |
                        <a href="<?php echo e(route('login')); ?>" class="text-primary fw-medium text-decoration-none">Login</a>
                    </p>
                </div>
            </div>
        </div>
...
</html><?php /**PATH E:\LocalServer\htdocs\myPortfolio\resources\views/admin/signup.blade.php ENDPATH**/ ?>