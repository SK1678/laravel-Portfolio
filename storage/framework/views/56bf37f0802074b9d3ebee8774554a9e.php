            ...
            <form action="<?php echo e(route('user.update', $user->id)); ?>" method="POST" enctype="multipart/form-data"
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('user.show', $user->id)); ?>" class="btn btn-light border btn-sm px-4">Cancel</a>
                    ...
                    <div class="col-md-4">
                                ...
                                <div class="profile-upload-container mb-3">
                                    ...
                                    <label for="profile_image"
                                        ...
                                        <?php if($user->profile_image): ?>
                                            <img id="image_preview" src="<?php echo e(asset('storage/' . $user->profile_image)); ?>"
                                ...
                                <div class="text-start mt-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="user_type" class="form-select shadow-none">
                                            <option value="user" <?php echo e($user->user_type == 'user' ? 'selected' : ''); ?>>User
                                            </option>
                                            <option value="admin" <?php echo e($user->user_type == 'admin' ? 'selected' : ''); ?>>Admin
                                            </option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <div class="form-check form-switch mt-4">
                                            <input class="form-check-input shadow-none" type="checkbox" name="is_site_owner"
                                                id="is_site_owner" value="1" <?php echo e($user->is_site_owner ? 'checked' : ''); ?>>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="profile_title" class="form-control shadow-none"
                                        value="<?php echo e(old('profile_title', $user->profile_title)); ?>"
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <?php if(isset($user->additional_info['cv']) && $user->additional_info['cv']): ?>
                                        <div class="col-md-12 mt-2 mt-md-0">
                                            <a href="<?php echo e(asset('storage/' . $user->additional_info['cv']['path'])); ?>"
                        ...
                        <div class="card border-0 shadow-sm rounded-3 mt-4">
                            ...
                            <div class="card-body px-4 pt-0" id="social-container">
                                ...
                                <?php $__currentLoopData = $socialLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="row g-2 mb-3 line-item align-items-center">
                                        <div class="col-md-4">
                                            <input type="text" name="social_links[<?php echo e($index); ?>][label]"
                                                class="form-control form-control-sm shadow-none"
                                                placeholder="Icon Class (e.g. ti ti-brand-linkedin)" value="<?php echo e($item['label'] ?? ''); ?>">
                                        </div>
                                        <div class="col-md-7">
                                            <input type="url" name="social_links[<?php echo e($index); ?>][link]"
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card border-0 shadow-sm rounded-3 mb-4">
                            ...
                            <div class="card-body px-4 pt-0" id="personal-container">
                                ...
                                <?php $__currentLoopData = $personal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="row g-2 mb-3 line-item">
                                        <div class="col-md-5">
                                            <input type="text" name="personal_info[<?php echo e($index); ?>][label]"
                                                class="form-control form-control-sm shadow-none"
                                                placeholder="Label (e.g. Gender)" value="<?php echo e($item['label'] ?? ''); ?>">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" name="personal_info[<?php echo e($index); ?>][value]"
                                                class="form-control form-control-sm shadow-none"
                                                placeholder="Value (e.g. Female)" value="<?php echo e($item['value'] ?? ''); ?>">
                                        </div>
                                        <div class="col-md-1">
                                            <button type="button" class="btn btn-sm btn-light text-danger border-0"
                                                onclick="removeItem(this)"><i class="ti ti-trash"></i></button>
                        ...
                        <div class="card border-0 shadow-sm rounded-3 mb-4">
                            ...
                            <div class="card-body px-4 pt-0" id="education-container">
                                ...
                                <?php $__currentLoopData = $education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="education-block p-3 border rounded-3 mb-4 bg-light bg-opacity-10 line-item">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            <h6 class="fw-bold text-primary mb-0 small">Entry #<?php echo e($loop->iteration); ?></h6>
                                            <button type="button" class="btn btn-sm btn-light text-danger border-0"
                                                onclick="removeItem(this)"><i class="ti ti-trash"></i></button>
                                        </div>
                                        <div class="row g-3 mb-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="education_info[<?php echo e($index); ?>][degree]"
                                                    class="form-control form-control-sm shadow-none" placeholder="e.g. BSc"
                                                    value="<?php echo e($item['degree'] ?? ''); ?>">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label extra-small fw-bold">Group / Major</label>
                                                <input type="text" name="education_info[<?php echo e($index); ?>][major]"
                                                    class="form-control form-control-sm shadow-none"
                                                    placeholder="e.g. Computer Science" value="<?php echo e($item['major'] ?? ''); ?>">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label extra-small fw-bold">Institution</label>
                                                <input type="text" name="education_info[<?php echo e($index); ?>][institution]"
                                                    class="form-control form-control-sm shadow-none"
                                                    placeholder="e.g. Harvard University"
                                                    value="<?php echo e($item['institution'] ?? ''); ?>">
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label extra-small fw-bold">Duration</label>
                                                <input type="text" name="education_info[<?php echo e($index); ?>][duration]"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" name="education_info[<?php echo e($index); ?>][result]"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" name="education_info[<?php echo e($index); ?>][year]"
                                                    class="form-control form-control-sm shadow-none" placeholder="e.g. 2022"
                                                    value="<?php echo e($item['year'] ?? ''); ?>">
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label extra-small fw-bold">Description</label>
                                                <textarea name="education_info[<?php echo e($index); ?>][description]"
                                                    class="form-control form-control-sm shadow-none" rows="2"
                                                    placeholder="Briefly describe your course or achievements..."><?php echo e($item['description'] ?? ''); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="document-vault mt-3 pt-3 border-top">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                ...
                                                <button type="button" class="btn btn-extra-sm btn-outline-secondary py-0 px-2"
                                                    onclick="addDocument(this, <?php echo e($index); ?>)">+ Add File</button>
                                            </div>
                                            <div class="document-list">
                                                <?php $docs = $item['documents'] ?? []; ?>
                                                <?php $__currentLoopData = $docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $docIndex => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="row g-2 mb-2 align-items-center doc-item">
                                                        <div class="col-md-3">
                                                            <input type="text"
                                                                name="education_info[<?php echo e($index); ?>][existing_docs][<?php echo e($docIndex); ?>][name]"
                                                                class="form-control form-control-xs shadow-none"
                                                                placeholder="Doc Name" value="<?php echo e($doc['name']); ?>">
                                                        </div>
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="hidden"
                                                                name="education_info[<?php echo e($index); ?>][existing_docs][<?php echo e($docIndex); ?>][path]"
                                                                value="<?php echo e($doc['path']); ?>">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <input type="password"
                                                                name="education_info[<?php echo e($index); ?>][existing_docs][<?php echo e($docIndex); ?>][password]"
                                                                class="form-control form-control-xs shadow-none"
                                                                placeholder="Password" value="<?php echo e($doc['password'] ?? ''); ?>">
                                                        </div>
                                                        <div class="col-md-1 text-end">
                        ...
                        <div class="card border-0 shadow-sm rounded-3">
                            ...
                            <div class="card-body px-4 pt-0" id="pro-container">
                                ...
                                <?php $__currentLoopData = $professional; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="professional-block p-3 border rounded-3 mb-4 bg-light bg-opacity-10 line-item">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            <h6 class="fw-bold text-success mb-0 small">Experience #<?php echo e($loop->iteration); ?></h6>
                                            <button type="button" class="btn btn-sm btn-light text-danger border-0"
                                                onclick="removeItem(this)"><i class="ti ti-trash"></i></button>
                                        </div>
                                        <div class="row g-3 mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="professional_info[<?php echo e($index); ?>][role]"
                                                    class="form-control form-control-sm shadow-none"
                                                    placeholder="e.g. Senior Developer" value="<?php echo e($item['role'] ?? ''); ?>">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label extra-small fw-bold">Company</label>
                                                <input type="text" name="professional_info[<?php echo e($index); ?>][company]"
                                                    class="form-control form-control-sm shadow-none"
                                                    placeholder="e.g. Google Inc." value="<?php echo e($item['company'] ?? ''); ?>">
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label extra-small fw-bold">Job Description</label>
                                                <textarea name="professional_info[<?php echo e($index); ?>][description]"
                                                    class="form-control form-control-sm shadow-none" rows="2"
                                                    placeholder="Describe your responsibilities..."><?php echo e($item['description'] ?? ''); ?></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label extra-small fw-bold">Start Date</label>
                                                <input type="date" name="professional_info[<?php echo e($index); ?>][start_date]"
                                                    class="form-control form-control-sm shadow-none"
                                                    value="<?php echo e($item['start_date'] ?? ''); ?>">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label extra-small fw-bold">End Date</label>
                                                <input type="date" name="professional_info[<?php echo e($index); ?>][end_date]"
                                                    class="form-control form-control-sm shadow-none"
                                                    value="<?php echo e($item['end_date'] ?? ''); ?>">
                                        ...
                                        <div class="document-vault mt-3 pt-3 border-top">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                ...
                                                <button type="button" class="btn btn-extra-sm btn-outline-secondary py-0 px-2"
                                                    onclick="addProDocument(this, <?php echo e($index); ?>)">+ Add File</button>
                                            </div>
                                            <div class="document-list">
                                                <?php $docs = $item['documents'] ?? []; ?>
                                                <?php $__currentLoopData = $docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $docIndex => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="row g-2 mb-2 align-items-center doc-item">
                                                        <div class="col-md-3">
                                                            <input type="text"
                                                                name="professional_info[<?php echo e($index); ?>][existing_docs][<?php echo e($docIndex); ?>][name]"
                                                                class="form-control form-control-xs shadow-none"
                                                                placeholder="Doc Name" value="<?php echo e($doc['name']); ?>">
                                                        </div>
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="hidden"
                                                                name="professional_info[<?php echo e($index); ?>][existing_docs][<?php echo e($docIndex); ?>][path]"
                                                                value="<?php echo e($doc['path']); ?>">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <input type="password"
                                                                name="professional_info[<?php echo e($index); ?>][existing_docs][<?php echo e($docIndex); ?>][password]"
                                                                class="form-control form-control-xs shadow-none"
                                                                placeholder="Password" value="<?php echo e($doc['password'] ?? ''); ?>">
                                                        </div>
                                                        <div class="col-md-1 text-end">
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\LocalServer\htdocs\myPortfolio\resources\views/admin/user-edit.blade.php ENDPATH**/ ?>