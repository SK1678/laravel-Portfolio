...
<aside id="sidebar" class="sidebar">
    <div class="logo-area">
        <a href="<?php echo e(route('dashboard')); ?>" class="d-inline-flex"><img
                src="<?php echo e(asset('/dashboard_assets/images/logo-icon.svg')); ?>" alt="" width="24">
            <span class="logo-text ms-2"> <img src="<?php echo e(asset('/dashboard_assets/images/logo.svg')); ?>" alt=""></span>
        </a>
    </div>
    <ul class="nav flex-column">
        <li><a class="nav-link <?php echo e((request()->routeIs('home') || request()->is('/')) ? 'active' : ''); ?>"
                href="<?php echo e(route('home')); ?>" target="blank"><i class="ti ti-world"></i><span
        ...
        <li><a class="nav-link <?php echo e((request()->routeIs('user*') || request()->is('user*')) ? 'active' : ''); ?>"
                href="<?php echo e(route('user')); ?>"><i class="ti ti-user"></i><span class="nav-text">User</span></a>
        </li>
        <li>
...
</aside><?php /**PATH E:\LocalServer\htdocs\myPortfolio\resources\views/admin/include/adminHeader.blade.php ENDPATH**/ ?>