...
<div class="row mb-4">
    <div class="col-12">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <form action="<?php echo e(route('admin.media')); ?>" method="GET" class="row g-3 align-items-center">
                    <div class="col-md-5">
                        <div class="input-group">
                            <span class="input-group-text bg-white border-end-0"><i class="ti ti-search text-muted"></i></span>
                            <input type="text" name="search" class="form-control border-start-0 ps-0" placeholder="Search by original file name..." value="<?php echo e(request('search')); ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
...
<div class="row mb-3">
    <div class="col-12 d-flex justify-content-between align-items-center">
        ...
        <div>
            <?php echo e($media->links('pagination::bootstrap-5')); ?>
        ...
        <div class="col-6 col-md-4 col-lg-3 col-xl-2 media-item-wrapper">
            <div class="card h-100 border-0 shadow-sm position-relative media-card overflow-hidden">
                <div class="position-absolute top-0 start-0 m-2 z-3">
                    <input class="form-check-input media-checkbox shadow-sm" type="checkbox" value="<?php echo e($item->id); ?>">
                </div>
                
                <div class="position-absolute top-0 end-0 m-2 z-3">
                    <form action="<?php echo e(route('admin.media.destroy', $item->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this file?');">
                        <?php echo csrf_field(); ?>
                ...
                <div class="card-img-top bg-light d-flex align-items-center justify-content-center overflow-hidden" style="height: 150px;">
                    <?php if($item->type == 'image'): ?>
                        <img src="<?php echo e(asset('storage/'.$item->file_path)); ?>" class="img-fluid object-fit-cover w-100 h-100" alt="<?php echo e($item->original_name); ?>">
                ...
                <div class="card-body p-2 text-center">
                    <p class="card-title text-truncate mb-1 small fw-bold" title="<?php echo e($item->original_name); ?>">
                        <?php echo e($item->original_name); ?>

                    </p>
                    <p class="card-text text-muted mb-1" style="font-size: 0.75rem;">
                        <?php echo e(number_format($item->file_size / 1024, 2)); ?> KB • <?php echo e(ucfirst($item->type)); ?>
                ...
                <div class="card-footer p-2 bg-white text-center border-top-0 d-flex justify-content-between">
                    <button class="btn btn-sm btn-light w-100 border copy-url-btn" data-url="<?php echo e(asset('storage/'.$item->file_path)); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if(bulkDeleteBtn) {
        bulkDeleteBtn.addEventListener('click', function() {
            if (confirm('Are you sure you want to delete selected media files?')) {
                ...
                fetch('<?php echo e(route("admin.media.bulkDelete")); ?>', {
                    method: 'POST',
                    headers: {
    ...
    function uploadFiles(files) {
        ...
        Array.from(files).forEach(file => {
            ...
            xhr.open('POST', '<?php echo e(route("admin.media.upload")); ?>', true);
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\LocalServer\htdocs\myPortfolio\resources\views/admin/media/index.blade.php ENDPATH**/ ?>