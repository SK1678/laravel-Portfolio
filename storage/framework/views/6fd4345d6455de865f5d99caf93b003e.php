        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-transparent border-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge hs-primary-bg rounded-pill"><?php echo e($categories->count()); ?> total</span>
                </div>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($category->parent_id ? 'bg-light-subtle' : ''); ?>">
                                        <td class="ps-4">
                                        ...
                                        <td><code class="hs-primary-text" style="font-size: 0.85rem;"><?php echo e($category->slug); ?></code></td>
                                        <td>
                                            <?php if($category->parent): ?>
                                                <span class="badge border text-dark fw-medium px-2 py-1"><?php echo e($category->parent->name); ?></span>
                                            <?php else: ?>
                                                <span class="badge bg-light-info text-info px-2 py-1">Root</span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-end pe-4">
                                            <?php if($category->is_protected): ?>
                                                <span class="text-muted small italic">Protected</span>
                                            <?php else: ?>
                                                <button type="button" class="btn btn-outline-danger btn-sm border-0 rounded-circle" onclick="deleteCategory(<?php echo e($category->id); ?>)" title="Delete">
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\LocalServer\htdocs\myPortfolio\resources\views/admin/pages/categories.blade.php ENDPATH**/ ?>