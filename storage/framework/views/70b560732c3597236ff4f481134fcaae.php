                ...
                <div class="col-md-5">
                    <div class="hs-card mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" value="<?php echo e($about->title ?? 'About'); ?>" placeholder="e.g. About Me">
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Section Subtitle</label>
                            <textarea name="subtitle" class="form-control" rows="2" placeholder="Enter a brief subtitle..."><?php echo e($about->subtitle); ?></textarea>
                        </div>
                        <div class="mb-0">
                            <label class="form-label small fw-bold">Objective Heading</label>
                            <input type="text" name="objective_title" class="form-control" value="<?php echo e($about->objective_title ?? 'Career Summary'); ?>" placeholder="e.g. Professional Profile">
                        </div>
                    </div>
                    ...
                    <div class="hs-card">
                        ...
                        <textarea name="career_objective" class="form-control" rows="8" placeholder="Enter your career objective..."><?php echo e($about->career_objective); ?></textarea>
                    </div>
                </div>
                                ...
                                <?php $__currentLoopData = $about->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="hs-detail-row mb-2">
                                        <div class="d-flex align-items-center gap-2 border rounded p-2 bg-light">
                                            ...
                                            <input type="text" name="labels[]" class="form-control form-control-sm w-25" value="<?php echo e($item['label']); ?>" placeholder="Label">
                                            <input type="text" name="values[]" class="form-control form-control-sm flex-grow-1" value="<?php echo e($item['value']); ?>" placeholder="Value">
