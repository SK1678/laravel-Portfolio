...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
            ...
            <input id="email" name="email" type="email" class="form-control" placeholder="name@example.com" value="<?php echo e(old('email')); ?>" required autofocus>
...
<?php endif; ?>
        ...
        <div class="mb-3">
            <label for="password" class="form-label d-flex justify-content-between small fw-medium text-secondary">
                <span>Password</span>
                <a href="<?php echo e(route('password.request')); ?>" class="link-primary text-decoration-none">Forgot Password?</a>
            </label>
...
<?php endif; ?>
        ...
        <div class="d-grid">
            <a href="<?php echo e(route('auth.google')); ?>" class="btn btn-outline-secondary d-flex align-items-center justify-content-center gap-2 py-2 border-opacity-50">
        ...
        <div class="text-center mt-4 pt-3">
            <p class="small text-muted mb-0">Don't have an account? <a href="<?php echo e(route('register')); ?>" class="link-primary fw-medium">Sign up</a></p>
        </div>
    </form>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH E:\LocalServer\htdocs\myPortfolio\resources\views/admin/login.blade.php ENDPATH**/ ?>